...
import com.rentalcar.respository.CustomerRespository;
import com.rentalcar.respository.PaymentRespository;
import com.rentalcar.respository.RentalRespository;
import com.rentalcar.respository.VehicleRespository;
...
//
//
//        Vehicle v1 = new Vehicle("Toyota" , "Yaris", 2010 , 25, Status.AVAILABLE);
//        Vehicle v2 = new Vehicle("Honda", "Civic", 2015, 30, Status.AVAILABLE);
//        Vehicle v3 = new Vehicle("Ford", "Focus", 2018, 35, Status.RENTED);
//        Vehicle v4 = new Vehicle("BMW", "320i", 2020, 55, Status.MAINTENANCE);
